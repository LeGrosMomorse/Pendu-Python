...
def animation_gagne(mot:str):
	you_win=[["   ",c+bold+" _  _  __   _  _    _  _  __  __ _    _ "+b+normal],["   ",c+bold+"( \/ )/  \ / )( \  / )( \(  )(  ( \  / \ "+b+normal],["   ",c+bold+" )  /(  O )) \/ (  \ /\ / )( /    /  \_/"+normal+b],["   ",c+bold+"(__/  \__/ \____/  (_/\_)(__)\_)__)  (_)"+b+normal]]
	...
	inter7a=[
		...
		["         ","     ┃  "+c+"   ┛ ┗ "+b],
		["         ","     ┃"],
		[y+"__________"+b," _________",
		 y+" ____________________________"+b],[""]]
